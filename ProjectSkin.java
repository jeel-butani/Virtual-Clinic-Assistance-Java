...
public class ProjectSkin extends JFrame implements ActionListener
{
	...
	ProjectSkin()
	{
		...
		lalOurSuggestion = new JLabel("Our Suggestion for Skin Problem is");
		lblSuggested1 = new JLabel("<html>If Skin Problem is less then 4 days then recommended medicine in below, for medicine detail and buy medicine click on it</html>");
		lblSuggested2 = new JLabel("<html>If you suffered for Skin Problem more then 4 days then please recommended Doctor in below, If you want visit docors website click on it and for appointment button is in bellow</html>");
		btnClose = new JButton("Close");
		btnApm = new JButton("Appointment");
		btnm1 = new JButton("<html>-Finuris Fusidic</html>");
		btnm2 = new JButton("<html>-Aloe Garcinia</html>");
		btnm3 = new JButton("<html>-Skin Fit</html>");
		btnm4 = new JButton("<html>-Keto AZ Lotion</html>");
		btnm5 = new JButton("<html>-Augmentin</html>");
		btnm6 = new JButton("<html>-Dermikem Oc Plus Cream</html>");
		btnm7 = new JButton("<html>-Zinderm An Gel</html>");
		btnm8 = new JButton("<html>-Skin Infections</html>");
		btnm9 = new JButton("<html>-E-Skin Drops</html>");
		btnm10 = new JButton("<html>-Antiseptic Cream</html>");
		btnm11 = new JButton("<html>-Boroline Ultra</html>");
		btnd1 = new JButton("<html>-Dr Suresh P. Joshipura<br>Coins Corner, Dr Yagnik Rd, Jagnath Plot, Rajkot, Gujarat 360001</html>");
		btnd2 = new JButton("<html>-Dr Shah<br>City Plaza, 209, Dr Yagnik Rd, Near, Jagnath Plot, Rajkot, Gujarat 360001</html>");
		btnd3 = new JButton("<html>-Dr Mukesh Ruparelia<br>13, Mangla Main Rd, Manhar Plot, Bhakti Nagar, Rajkot, Gujarat 360002</html>");
		btnd4 = new JButton("<html>-Dr. Dhairya Bhat<br>204, Helios, Galaxy Cir, Pal Gam, Surat, Gujarat 394510</html>");
		btnd5 = new JButton("<html>-Dr. Chetan Vispute<br>Shree Dutta House, Babajipura, Vadodara, Gujarat 390001</html>");
	...
	{
		ProjectSkin mu = new ProjectSkin();
		mu.setVisible(true);
	}
