...
public class ProjectHeadache extends JFrame implements ActionListener
{
	...
	ProjectHeadache()
	{
		...
		lalOurSuggestion = new JLabel("Our Suggestion for Headache is");
		...
		btnm1 = new JButton("<html>-Shirashoolari Vati</html>");
		btnm2 = new JButton("<html>-Vishranti Destress</html>");
		btnm3 = new JButton("<html>-NOW Foods, Butterbur</html>");
		btnm4 = new JButton("<html>-HealthVit Migraneed Migraine Oil</html>");
		btnm5 = new JButton("<html>-Glycomet GP 05</html>");
		btnm6 = new JButton("<html>-Pacimol</html>");
		btnm7 = new JButton("<html>-Emami Mentho Plus</html>");
		btnm8 = new JButton("<html>-Himalaya Platenza</html>");
		btnm9 = new JButton("<html>-Dolo</html>");
		btnm10 = new JButton("<html>-Medomol</html>");
		btnm11 = new JButton("<html>-Bioayurveda</html>");
		btnd1 = new JButton("<html>-Dr. Punit Trivedi<br> Dr Yagnik Rd, Manhar Plot, Bhakti Nagar, Rajkot 360001</html>");
		btnd2 = new JButton("<html>-Dr Jigar Parekh<br>Ambition+, 2nd floor, Rajnagar Chowk, Nana Mava Rd, Rajkot 360004</html>");
		btnd3 = new JButton("<html>-Dr Dushyant Sankalia<br> 12/14, Vidya Nagar Main Rd, Manhar Plot, Bhakti Nagar, Rajkot 360002</html>");
		btnd4 = new JButton("<html>-Dr Devshi Visana<br>203 Spectrum, Vivekanand Chowk, Memnagar, Ahmedabad 380052</html>");
		btnd5 = new JButton("<html>-Dr. Dhaval's Neuro Clinic<br>Wood Square, 305, 3rd, LP Savani Rd, Adajan, Surat, Gujarat 395009</html>");
	...
	{
		ProjectHeadache mu = new ProjectHeadache();
		mu.setVisible(true);
	}
