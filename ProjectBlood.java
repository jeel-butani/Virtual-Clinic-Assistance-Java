...
public class ProjectBlood extends JFrame implements ActionListener
{
	...
	ProjectBlood()
	{
		...
		lalOurSuggestion = new JLabel("Our Suggestion for Heart Problems is");
		lblSuggested1 = new JLabel("<html>If Heart Problems is less then 4 days then recommended medicine in below, for medicine detail and buy medicine click on it</html>");
		lblSuggested2 = new JLabel("<html>If you suffered for Heart Problems more then 4 days then please recommended Doctor in below, If you want visit docors website click on it and for appointment button is in bellow</html>");
		btnClose = new JButton("Close");
		btnApm = new JButton("Appointment");
		btnm1 = new JButton("<html>-Coversyl 4mg</html>");
		btnm2 = new JButton("<html>-Dytor Plus</html>");
		btnm3 = new JButton("<html>-Cardivas</html>");
		btnm4 = new JButton("<html>-Inlife</html>");
		btnm5 = new JButton("<html>-Berbeshine</html>");
		btnm6 = new JButton("<html>-Potrate</html>");
		btnm7 = new JButton("<html>-Viviloref</html>");
		btnm8 = new JButton("<html>-Neurobion Forte</html>");
		btnm9 = new JButton("<html>-Rediva</html>");
		btnm10 = new JButton("<html>-Arjunarishta</html>");
		btnm11 = new JButton("<html>-Siddhayu</html>");
		btnd1 = new JButton("<html>-Dr. Mridul Sharma<br>Sterling Hospital, 150 Feet Ring Road, Rajkot, Gujarat 360007</html>");
		btnd2 = new JButton("<html>-Dr Dharmesh Solanki<br>Hem Arcade, 503, Yagnik Road, Dr Radha Krishnan Marg, Rajkot 360001</html>");
		btnd3 = new JButton("<html>-Dr. Kinjal Niranjan Bhatt<br>Plot No. 251, 150 Feet Ring Road, Rajkot, Gujarat 360007</html>");
		btnd4 = new JButton("<html>-Dr. Mihir Tanna<br>7QQV+6X9, Vidya Nagar Main Road, Bhakti Nagar, Rajkot, Gujarat 360001</html>");
		btnd5 = new JButton("<html>-Dr. Harsh Ghonia<br>Christ Hospital, Jamnagar - Rajkot Hwy, Madhapar, Chowkd 360006</html>");
	...
	{
		ProjectBlood mu = new ProjectBlood();
		mu.setVisible(true);
	}
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			ProjectMail pm = new ProjectMail("Heart Problems");
			pm.setVisible(true);
		}
	}
}